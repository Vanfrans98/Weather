...
public class Weather implements Parcelable
{
    ...
    protected Weather(android.os.Parcel in) {
        ...
        in.readList(this.weather, (Weather_1.class.getClassLoader()));
     ...
     * @param wind
     */
    public Weather(Coord coord, List<Weather_1> weather, String base, Main main, Integer visibility, Wind wind, Clouds clouds, Integer dt, Sys sys, Integer timezone, Integer id, String name, Integer cod) {
        super();
        this.coord = coord;
